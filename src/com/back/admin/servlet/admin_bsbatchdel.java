...
/**
 * Servlet implementation class admin_bsbatchdel
 */
@WebServlet("/Back/admin_bsbatchdel.do")
public class admin_bsbatchdel extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public admin_bsbatchdel() {
        super();
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	        ...
	        response.sendRedirect("/Team/Back/admin_bestoplist.do");
		}  catch (Exception e) {
