...
/**
 * Servlet implementation class admin_stop
 */
@WebServlet("/Back/admin_stop.do")
public class admin_stop extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String type="停用";
			String operate=admin_name+"进行了管理员停用操作";
