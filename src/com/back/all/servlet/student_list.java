...
/**
 * Servlet implementation class student_list
 */
@WebServlet("/Back/student_list.do")
public class student_list extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			List<StudentList> liststudentlist =sls.listall();
				...
				request.getRequestDispatcher("/Back/S_student_list.jsp").forward(request, response);
