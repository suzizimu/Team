 ...
 */
@WebServlet("/Back/student_register.do")
public class student_register extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			List<StudentList> liststudentlist =sls.checkstatuslist();
				...
				request.getRequestDispatcher("/Back/S_student_register.jsp").forward(request, response);
