...
/**
 * Servlet implementation class FailItemCheckServlet
 */
@WebServlet("/FailItemCheck.do")
public class FailItemCheckServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FailItemCheckServlet() {
        super();
