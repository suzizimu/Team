...
/**
 * Servlet implementation class firmlist_batchdelete
 */
@WebServlet("/Back/firmlist_batchdelete.do")
public class firmlist_batchdelete extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public firmlist_batchdelete() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ls.addlog(log);
	        as.delbacthfirm(IDS); 	
	        request.getRequestDispatcher("/Back/firm_list.do").forward(request, response);
		}  catch (Exception e) {
