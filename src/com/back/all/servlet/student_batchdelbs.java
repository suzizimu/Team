...
/**
 * Servlet implementation class student_batchdelbs
 */
@WebServlet("/Back/student_batchdelbs.do")
public class student_batchdelbs extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public student_batchdelbs() {
        super();
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	        ...
	        request.getRequestDispatcher("/Back/student_bestoplist.do").forward(request, response);
		}  catch (Exception e) {
