...
/**
 * Servlet implementation class student_start
 */
@WebServlet("/Back/student_start.do")
public class student_start extends HttpServlet {
   ...
   // super.service(arg0, arg1);
	   String ID=request.getParameter("ID");
		...
		String type="启用";
		String operate=admin_name+"进行了学生启用操作";
