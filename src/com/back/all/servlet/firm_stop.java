...
/**
 * Servlet implementation class firm_stop
 */
@WebServlet("/Back/firm_stop.do")
public class firm_stop extends HttpServlet {
   ...
   // super.service(arg0, arg1);
	   String ID=request.getParameter("ID");
		...
		String type="停用";
		String operate=admin_name+"进行了公司停用";
		...
		fls.stop(Integer.parseInt(ID));
		
		
		//添加消息
				String  content2="系统消息：您的企业已被禁用";
