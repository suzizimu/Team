...
/**
 * Servlet implementation class teacherlist_batchdeletebs
 */
@WebServlet("/Back/teacherlist_batchdeletebs.do")
public class teacherlist_batchdeletebs extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public teacherlist_batchdeletebs() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	        ...
	        request.getRequestDispatcher("/Back/teacher_bestoplist.do").forward(request, response);
		}  catch (Exception e) {
