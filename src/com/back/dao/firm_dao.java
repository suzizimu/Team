...
public class firm_dao {
    ...
    public void firm_indentification_update(Firm firm){
    	String sql="update firm set FirmID=?,CardStart=?,Picture=?,Status='Ing' where FirmName=?";
	 ...
	 */
     ...
     public List<Resume> firm_resume_list(String FirmName){
    	 String sql="select * from resume_list where firmname=? and resume != ''";
    	 List<Map<String, Object>> list=DBUtil.list(sql,FirmName);
      	 if(list!=null&&list.size()!=0){
      		List<Resume> listresume=new ArrayList<Resume>();
      		for(Map<String,Object> map:list){
      ...
      * @return
      */
     public List<Item> firm_item_list(String name){
    	 String sql="select * from stu_start where CheckStatus='2' and Status='1' and (FirmName='' or FirmName=?)";
      ...
      * @return
      */
     public List<Message> firm_message_list(String FirmName){
    	 String sql="select * from  message where receive=? and type='企业'";
    	 List<Map<String, Object>> list= DBUtil.list(sql,FirmName);
    	 if(list!=null&&list.size()!=0){
    		 ...
    		 for(Map<String,Object> map:list){
    			 ...
    			 message.setDate((String) map.get("Date"));
      ...
      * @param ID
      */
     public void firm_message_delete(int ID){
      ...
      * @return
      */
     public long firm_message_count(String FirmName){
    	 String sql="select count(*) as num from message where receive=? and type='企业'";
    	 List<Map<String, Object>> list=DBUtil.list(sql, FirmName);
