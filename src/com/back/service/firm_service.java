...
public class firm_service {
	 ...
	 */
      ...
      * @throws Exception
      */
     public List<Item> firm_item_list(String name) throws Exception{
    	 try {
			return fd.firm_item_list(name);
		} catch (Exception e) {
			// TODO: handle exception
      ...
      * @throws Exception
      */
     public List<Message> firm_message_list(String FirmName) throws Exception{
    	 try {
			return fd.firm_message_list(FirmName);
		} catch (Exception e) {
			// TODO: handle exception
			throw new Exception("遍历属于自己的消息列表失败，原因是："+e.getMessage());
		}
     }
     /**
      * 删除消息
      ...
      * @throws Exception
      */
     public void firm_message_delete(int ID) throws Exception{
    	 try {
			fd.firm_message_delete(ID);
		} catch (Exception e) {
			// TODO: handle exception
			throw new Exception("删除消息失败，原因是:"+e.getMessage());
		}
     }
     /**
      * 统计消息数量
      ...
      * @throws Exception
      */
     public long firm_message_count(String FirmName) throws Exception{
    	 try {
			return fd.firm_message_count(FirmName);
		} catch (Exception e) {
			// TODO: handle exception
			throw new Exception("统计消息数量失败，原因是："+e.getMessage());
		}
     }
}
