...
/**
 * Servlet implementation class firm_jobfair_attend_list
 */
@WebServlet("/firm_jobfair_attend_list.do")
public class firm_jobfair_attend_list extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public firm_jobfair_attend_list() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(Status.equals("No")||Status.equals("Ing")){
				...
				List<JobFair> list=fs.firm_jobfair_attend_list(FirmName);
				
				request.setAttribute("list",list);
				request.getRequestDispatcher("Back/F_firm_jobfair_attend_list.jsp").forward(request, response);
			}
