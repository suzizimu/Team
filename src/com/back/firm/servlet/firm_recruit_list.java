...
/**
 * Servlet implementation class firm_recruit_list
 */
@WebServlet("/firm_recruit_list.do")
public class firm_recruit_list extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public firm_recruit_list() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(Status.equals("No")||Status.equals("Ing")){
				...
				request.getRequestDispatcher("Back/F_firm_recruit_list.jsp").forward(request, response);
			}
