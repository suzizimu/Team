...
/**
 * Servlet implementation class firm_resume_collect_list
 */
@WebServlet("/firm_resume_collect_list.do")
public class firm_resume_collect_list extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public firm_resume_collect_list() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(Status.equals("No")||Status.equals("Ing")){
				...
				List<Resume>  list=fs.firm_resume_collect_list(FirmName);
