...
/**
 * Servlet implementation class firm_item_list
 */
@WebServlet("/firm_item_list.do")
public class firm_item_list extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public firm_item_list() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(Status.equals("No")||Status.equals("Ing")){
               ...
               List<Item> list=fs.firm_item_list(FirmName);
				
			   request.setAttribute("list",list);
			   request.getRequestDispatcher("Back/F_firm_item_list.jsp").forward(request, response);
			}				
		} catch (Exception e) {
