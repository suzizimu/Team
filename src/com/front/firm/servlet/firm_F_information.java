...
/**
 * Servlet implementation class firm_F_information
 */
@WebServlet("/firm_F_information.so")
public class firm_F_information extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public firm_F_information() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<Firm>  list=fs.firm__F_information();
