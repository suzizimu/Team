        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu multi-level" role="menu">
                        <li>
                            <a tabindex="-1" href="information_frontinforlist.so?type=创业动态">企业指南</a>
                        </li>
                        <li>
              ...
              <div class="col-md-10 col-md-offset-0">
                 ...
                 <center>
             	 <ul class="list-inline">
                    <li><a href="../FrontQueryRecruit.so?nowPage=1&firm=${firm }&work=${work}&EducationBgd=${EducationBgd }" ><input type="button" class=" class="btn btn border-theme" value="首页"> </a></li>
                    <li><a href="../FrontQueryRecruit.so?nowPage=${page.nowPage<=1?1:page.nowPage-1}&firm=${firm }&work=${work}&EducationBgd=${EducationBgd }" ><input type="button" class=" class="btn btn border-theme" value="上一页"></a></li>
                    <li><a data-filter="*">${page.getNowPage()==null?1:page.getNowPage()}</a></li>
                    <li><a href="../FrontQueryRecruit.so?nowPage=${page.nowPage>=page.totalpage?page.totalpage:page.nowPage+1}&firm=${firm }&work=${work}&EducationBgd=${EducationBgd }" ><input type="button" class=" class="btn btn border-theme" value="下一页"></a></li>
                    <li><a href="../FrontQueryRecruit.so?nowPage=${page.totalpage}&firm=${firm }&work=${work}&EducationBgd=${EducationBgd }"><input type="button" class=" class="btn btn border-theme" value="末页"></a></li>
                </ul>
                </center>
                </div>
            </div>
