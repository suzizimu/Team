                        ...
                        <div class="row">                       
                            <div class="col-md-6 margin20">
                                <a href="#">
                                    <div class="item-img-wrap">
                                        <img src="work/招聘.jpg" class="img-responsive" alt="workimg">
                            ...
                            <div class="col-md-6 margin20">
                                <ul class="list-inline post-detail"> 
                                  <li><i class="fa fa-calendar"></i>${jobfair.date}</li>                                 
                                </ul>
                                <h2><a href="../firm_F_jobfair_detail.so?ID=${jobfair.ID}">${jobfair.title}</a></h2>
                                <p>
                                   ${jobfair.content}
                                </p>
                                <p><a href="../firm_F_jobfair_detail.so?ID=${jobfair.ID}" class="btn btn-theme-dark">详情</a></p>
                            </div>
                        </div>
                    </div><!--blog post-->
                   </c:forEach>
