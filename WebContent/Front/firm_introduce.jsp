    ...
    <div class="container">
        ...
        <div class="container">     
           ...
           <div class="row margin10">
              <form action="/Team/firm_F_information_select.so" method="post"> 
                <div class="col-md-3">                 
                     <input name="FirmName" type="text" class="form-control" placeholder="企业名称" >                     
                </div>
                ...
                <div class="portfolio-box iso-call col-3-space">
                  ...
                  <c:forEach items="${list}" var="firm">
                    <div class="project-post photography branding">
                        ...
                        <div class="work-desc">
                            <h3><a href="../firm_F_informaiton_detail.so?ID=${firm.ID}&FirmName=${firm.firmName}">${firm.firmName}</a></h3>
