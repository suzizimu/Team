        ...
        <div class="container blog-left-img">
            <div class="row">
                <div class="col-md-8">
                  ...
                  <c:forEach items="${listaudition}" var="audition">
                    <!--blog post-->
                       <div class="blog-post" >
                        <div class="row">
                            <div class="col-md-6 margin20">
                                <a href="#">
                                    <div class="item-img-wrap">
                                        <img width="400px" height="200px" src="${audition.getPicture()}" class="img-responsive" alt="workimg">
                            ...
                            <div class="col-md-6 margin20">
                                <ul class="list-inline post-detail" >
                                    ...
                                    <li>${audition.getAuthor()}</li>
                                    <li><i class="fa fa-calendar"></i>${audition.getAuthor()}</li>
                                    <li><i class="fa fa-tag"></i>${audition.getDate()}</li>
                                </ul>
                                <h2><a href="#">${audition.getTitle()}</a></h2>
                                <p style="width:400px; height:100px; text-overflow:ellipsis;  white-space:nowrap;   overflow:hidden;">
                                     ${audition.getContent()}                          
                                </p >
                                <p><a href="/Team/Front/information_detail.so?ID=${audition.ID}" class="btn btn-theme-dark">更多内容...</a></p>
                            </div>  
                        </div>
                    </div>
                    </c:forEach>
