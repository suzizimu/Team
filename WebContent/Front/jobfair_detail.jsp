          ...
          <div class="row">          
             <div class="col-md-10 col-md-offset-0">                      
               <div class="about-author">                             
                  <h3 class="colored-text">${jobfair.title}</h3>                    
                  <table width="100%">
                  <tr width="100%"><td align="left" width="50%">场地:${jobfair.address}</td><td width="50%" align="right">参会企业数：<font color="red">${jobfair.firmNumber}</font></td></tr>                 
                  <tr width="100%"><td align="left" width="50%">时间:${jobfair.date}</td><td width="50%" align="right">招聘职位数：<font color="red">${jobfair.postNumber}</font></td></tr>   
                  </table>                                                                  
                </div><!--about author-->           
           ...
           <div class="row">
              ...
              <h4>参会企业</h4>
                 ...
                 <c:forEach items="${list}" var="jobfair_list">
                   <hr>                   
                   <h4 class="colored-text"><a href="../firm_F_informaiton_detail.so?FirmName=${jobfair_list.firmName}">${jobfair_list.firmName}</a></h4>
                   <table width="100%">
                   <tr width="100%"><td align="left" width="50%">使用时间：${jobfair_list.date}</td><td width="50%" align="right" rowspan="1">发布职位数：<font color="red">${jobfair_list.selfPostNumber}</font></td></tr>
                   <tr width="100%"><td align="left" width="50%">招聘会地址：${jobfair_list.address}</td><td width="50%" align="right"></td></tr>
                   </table>
                 </c:forEach>                    
