...
<body>
<div class="pd-20">
  <form action="../StudentUpdatePassword.sdo" method="post" class="form form-horizontal" id="updatepassword">
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>用户编号：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="${student.getID() }" readonly="readonly" placeholder="" id="ID" name="ID">
      </div>
      <div class="col-4"> </div>
    </div>
     <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="password" class="input-text" value="" placeholder="" id="oldpassword" name="oldpassword" datatype="*5-16" nullmsg="原密码不能为空" ajaxurl="../StudentPasswordCheck.sdo">
      </div>
      <div class="col-4"> </div>
    </div>
     <div class="row cl">
