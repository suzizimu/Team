...
<body>
<div class="pd-20">
	<form action="/Team/Back/information_add.do" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
		<div class="row cl">
			<label class="form-label col-2">标题：</label>
			<div class="formControls col-2">
				<input type="text" class="input-text" value="" placeholder="" id="" name="title" style="width:250px">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-2">来源：</label>
			<div class="formControls col-2">
				<input type="text" class="input-text" value="" placeholder="" id="" name="sourse">
			</div>
		</div>
	<div class="row cl">
	...
	<label class="form-label col-2"><span class="c-red">*</span>分类栏目：</label>
		...
		<div class="row cl">
			...
			<div class="formControls col-7">
				<textarea name="content" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-5000" dragonfly="true" nullmsg="内容不能为空！" onKeyUp="textarealength(this,200)"></textarea>
