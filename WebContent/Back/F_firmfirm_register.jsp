...
<body> 	
<div class="pd-20">
	<form action="/Team/firm_register.do" method="post" class="form form-horizontal" id="form-admin-add">
		<div class="row cl">
			<label class="form-label col-3"><span class="c-red">*</span>企业名称：</label>
			<div class="formControls col-5">
				<input type="text"  style="width:250px;" class="input-text" placeholder="请输入与企业营业执照一致的企业全称" id="FirmName" name="FirmName" datatype="*2-16" nullmsg="企业名称不能为空！" ajaxurl="../firm_check.do" >
			</div>
			<div class="col-4"> </div>
		</div>
		...
		<div class="row cl">
           ...
           <div class="formControls col-5">
               <input type="text" style="width:250px;" class="input-text" placeholder="请输入有效邮箱" name="Email" id="email" datatype="e" nullmsg="邮箱不能为空！">
           </div>
          <div class="col-4"> </div>
        </div>
        ...
        <div class="row cl">
           ...
           <div class="formControls col-5">
              <input type="text" style="width:250px;" class="input-text" value="" placeholder="请输入手机号" id="Tel" name="Tel"  datatype="m" nullmsg="手机号不能为空！">
            </div>
           <div class="col-4"> </div>
        </div>
