...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 招聘会 <span class="c-gray en">&gt;</span>已参加的招聘会<a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
		...
		<tbody>
			<c:forEach items="${list}" var="jobfair">
		     <tr class="text-c">
		       ...
		       <td>${jobfair.date}</td>	
		       <td>${jobfair.selfPostNumber}</td>			  
			   <td class="td-manage">
			      <a style="text-decoration:none" class="ml-5"  href="../firm_jobfair_recruit_list.do?FairID=${jobfair.fairID}" >发布职位</a> 			      				  
			   </td>
			</tr>
		  </c:forEach>		
		</tbody>
