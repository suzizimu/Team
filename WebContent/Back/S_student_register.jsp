	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
			    ...
			    <td><a href="${student.getPicture()}"  ><img width="150px" height="150px" src="${student.getPicture()}"></a></td>
			    <td>${student.getSchool()}</td>
				<td>${student.getProvince()}</td> 
				<td ><a href="${student.getStuPic()}"  data-lightbox="gallery" ><img width="150px" height="150px" src="${student.getStuPic()}"></a></td>
...
/*用户-全选*/
 ...
 function student_checked(obj,id){
	...
	layer.confirm('确认要通过吗？',function(index){
		$.post("/Team/Back/student_check.do",{messege:messege},function(data){
