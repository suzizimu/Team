	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<c:forEach items="${FirmCollectList }" var="fir"> 
			<tr class="text-c">
				...
				<td> <a title="取消收藏" href="javascript:;" onclick="member_del(this,${fir.getID() })" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
...
function member_del(obj,id){
	layer.confirm('确认要取消收藏吗？',function(index){
		layer.open({
		    ...
		    ,content: '../StudentDeleteFirmCollect.sdo?CollectID='+id,
...
$("#prodelete").click(function(){
	layer.confirm('确认要取消收藏吗？',{icon:0,},function(index){
		var status=[];
		...
		layer.open({
		    ...
		    ,maxmin: true //允许全屏最小化
		    ,anim: 2 //0-6的动画形式，-1不开启
		    ,content: '../StudentDeleteFirmCollect.sdo?CollectID='+status,
		});
	});
})
</script> 
