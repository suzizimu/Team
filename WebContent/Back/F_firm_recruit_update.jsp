...
<body> 	
<div class="pd-20">
	<form action="/Team/firm_recruit_update.do" method="post" class="form form-horizontal" id="form-admin-add">
	...
	<input id="btn_MajorID_2" type="button" value="${recruit.job}" onclick="majorSelect_2()" />
	...
	<input id="MajorID_22" type="hidden" name="MajorID_22" value="" />             
        ...
        <div class="row cl">
           ...
           <div class="formControls col-5">
              <input type="text" style="width:250px;" class="input-text" placeholder="请输入部门信息"  name="Department"  datatype="*" nullmsg="部门不能为空！" value="${recruit.department}">
            </div>
           <div class="col-4"> </div>
        </div>
		...
		<div class="row cl">
			...
			<div class="formControls col-2 skin-minimal">
			  <div class="check-box">
					<input type="checkbox" id="flag1" name="Welfare" value="公积金">公积金
					<label for="checkbox-pinglun">&nbsp;</label>								
		      </div>
			  <div class="check-box">
					<input type="checkbox" id="flag2" name="Welfare" value="工伤保险">工伤保险
					<label for="checkbox-pinglun">&nbsp;</label>				
		      </div>			 
		      <div class="check-box">
					<input type="checkbox" id="flag3" name="Welfare" value="医疗保险">医疗保险
					<label for="checkbox-pinglun">&nbsp;</label>				
		      </div>			
		      <div class="check-box">
					<input type="checkbox" id="flag4" name="Welfare" value="养老保险">养老保险
					<label for="checkbox-pinglun">&nbsp;</label>				
		      </div>
		      <div class="check-box">
					<input type="checkbox" id="flag5" name="Welfare" value="生育保险">生育保险
					<label for="checkbox-pinglun">&nbsp;</label>				
		      </div>
		      <div class="check-box">
					<input type="checkbox" id="flag6" name="Welfare" value="失业保险">失业保险
					<label for="checkbox-pinglun">&nbsp;</label>				
		      </div>
		      <div class="check-box">
					<input type="checkbox" id="flag7" name="Welfare" value="其他福利">其他福利
					<label for="checkbox-pinglun">&nbsp;</label>				
		      </div>
		    </div>
			<div class="col-4"> </div>
        ...
        <div class="row cl">
           ...
           <div class="formControls col-5">
              <textarea name="Job_Des" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-200" dragonfly="true" nullmsg="企业简介不能为空！" onKeyUp="textarealength(this,200)">${recruit.job_Des}</textarea>
			  <p class="textarea-numberbar"><em class="textarea-length">0</em>/200</p>    </div>
           <div class="col-4"> </div>
        </div>
                 
		<div class="row cl">${msg}
		<input type="hidden" name="id" value="${recruit.ID}"> <%--隐藏域获取地址基本信息 --%>
		<input type="hidden" id="Pay_hidden" name="Pay_hidden" value="${recruit.pay}"> <%--隐藏域获取地址基本信息 --%>
		<input type="hidden" id="Welfare_hidden" name="Welfare_hidden" value="${recruit.welfare}"> <%--隐藏域获取地址基本信息 --%>
		<input type="hidden" id="EducationBgd_hidden" name="EducationBgd_hidden" value="${recruit.educationBgd}"> <%--隐藏域获取地址基本信息 --%>
		<input type="hidden" id="JobNature_hidden" name="JobNature_hidden" value="${recruit.jobNature}"> <%--隐藏域获取地址基本信息 --%>	
		</div>
		<div class="row cl">
...
$(function(){
	...
	var temp3=$("#EducationBgd_hidden").val()
	 $("select option").each(function(){  
    if($(this).val()==temp3){  
        $(this).attr("selected","selected");  
     }  
	...
	var temp4=$("#JobNature_hidden").val()
	 $("select option").each(function(){  
    if($(this).val()==temp4){  
        $(this).attr("selected","selected");  
     }  
