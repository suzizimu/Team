	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td >${teacher.getAcademy()}</td>
				<td class="td-status"><span class="label label-success radius">${teacher.getStatus()}</span></td>
				<td class="td-manage"><a style="text-decoration:none"  href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a> 			
				<a title="删除"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
	</c:forEach>
...
function admin_bacthdel(){
	...
	var temp=0;
	 ...
	 if(temp==admin_ids.length){
		 ...
		 window.location.href="/Team/Back/teacherlist_batchdelete.do?ID="+ID;
	 } 
}
/*用户-全选*/
 function checkedall(){
 ...
 function teacher_stop(obj,id){
 	...
 	alert(ID);
 	layer.confirm('确认要停用吗？',function(index){
 		$.post("/Team/Back/teacher_stop.do",{ID:ID},function(data){
