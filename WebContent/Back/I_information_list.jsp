...
<form action="/Team/Back/admin_select.do" method="post">
	...
	<a href="javascript:;" onclick="member_add('添加信息','I_information_add.jsp','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加信息</a></span> <span class="r">共有数据：<strong>88</strong> 条</span> </div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				<td><input type="checkbox" id="${information.ID}" value="1" name="admin_ids"></td>			
			    <td><u style="cursor:pointer" class="text-primary" onclick="member_show('${information.getTitle()}','/Team/Back/information_onedetail.do?ID=${information.ID}','${information.ID}','860','600')">${information.getTitle()}</u></td>
			    <td>${information.getDate()}</td>
				<td>${information.getSkimtime()}</td> 
				<td >${information.getSourse()}</td>
				<td  >${information.getAuthor()}</td>
				<td >${information.getType()}</td>
				<td ><img width="200px" height="200px" src="${information.getPicture()}"></td>
				<td class="td-manage">
				<a style="text-decoration:none" onClick="admin_stop(this,${information.getID()})" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a> 
				<a title="编辑" href="javascript:;" onclick="admin_edit('管理员编辑','/Team/Back/information_update.do?ID=${information.getID()}',${information.getID()},'800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
				<a title="删除" href="javascript:;" onclick="admin_del(this,${information.getID()})" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
			</tr>
	</c:forEach>
...
function admin_del(obj,id){
	...
	layer.confirm('确认要删除吗？',function(index){
		$.post("/Team/Back/information_delete.do",{ID:ID},function(data){
...
function admin_stop(obj,id){
	...
	alert(ID);
	layer.confirm('确认要删除吗？',function(index){
		$.post("/Team/Back/admin_stop.do",{ID:ID},function(data){
...
function admin_bacthdel(){
	...
	var temp=0;
	 ...
	 if(temp==admin_ids.length){
		 ...
		 window.location.href="/Team/Back/information_batchdel.do?ID="+ID;
	 } 
}
/*用户-全选*/
 function checkedall(){
