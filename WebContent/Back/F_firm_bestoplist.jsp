	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
			    ...
			    <td>${firm.cardStart}</td> 
				<td class="td-status"><span class="label label-success radius">${firm.getStatus()}</span></td>
				<td class="td-manage"><a style="text-decoration:none" onClick="firm_start(this,${firm.getID()})" href="javascript:;" title="启用"><i class="Hui-iconfont">&#xe6e1;</i></a> 		
...
function admin_bacthdel(){
	...
	var temp=0;
	 ...
	 if(temp==admin_ids.length){
		 ...
		 window.location.href="/Team/Back/firm_batchdeletebs.do?ID="+ID;
	 } 
}

/*用户-启用*/
function firm_start(obj,id){
	var ID=id;
	
	layer.confirm('确认启用吗？',function(index){
		$.post("/Team/Back/firm_start.do",{ID:ID},function(data){
