	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td class="td-manage"><a style="text-decoration:none" title="启用"><i class="Hui-iconfont">&#xe6e1;</i></a> 
...
function admin_bacthdel(){
	...
	var temp=0;
	 ...
	 if(temp==admin_ids.length){
		 ...
		 window.location.href="/Team/Back/teacherlist_batchdeletebs.do?ID="+ID;
	 } 
}
/*用户-全选*/
 function checkedall(){
 ...
 function teacher_start(obj,id){
 	...
 	layer.confirm('确认要启用吗？',function(index){
 		$.post("/Team/Back/teacher_start.do",{ID:ID},function(data){
