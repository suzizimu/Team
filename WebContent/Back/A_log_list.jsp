...
<form action="/Team/Back/admin_select.do" method="post">
	...
	<a href="javascript:;" onclick="admin_bacthdel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
	                                                         <a href="javascript:;" onclick="member_add('添加用户','A_admin_add.jsp','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a></span> <span class="r">共有数据：<strong>88</strong> 条</span> </div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td class="td-manage"><a style="text-decoration:none" onClick="member_stop(this,${admin.getID()})" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a> 
	 ...
	 if(temp==admin_ids.length){
		 layer.confirm('确认要删除吗？',function(index){
			...
			layer.confirm('确认要删除吗？',function(index){
				 ...
				 $.post("/Team/Back/admin_batchdelete.do",{ID:ID},function(data){
					 layer.msg('已删除!',{icon:1,time:1000});
			            layer.close(index);
					})				
			});
